...
opt.data = os.getenv('DATA_ROOT_2') or '/data/local/imagenet-fetch/256'
...
local trainCache = paths.concat(cache, cache_prefix .. '_trainCache_data2.t7')
...
local trainHook = function(self, path)
   ...
   --print(input:size())
   --io.write(string.format('w1 = %d, h1 = %d, iW = %d, iH = %d, oW = %d, oH = %d', w1,h1,iW,iH,oW,oH))
