...
print('In doneky_lsun.lua 1: ')

print('In doneky_lsun.lua 2: ')

print('In doneky_lsun.lua 3: ')

print('In doneky_lsun.lua 4: ')

print('In doneky_lsun.lua 5: ')
...
print(string.format('The training path is %s', trainPath))
print(string.format('Make sure that the LMDB file is at %s: %s_train_lmdb', trainPath,classes[1]))
for i=1,#classes do
   ...
   print('getting db: lmdb.env: ',classes[i])                               
   trainLoader.db[i]:open()
   print('opening db: db[i]:open(): ',classes[i])  
