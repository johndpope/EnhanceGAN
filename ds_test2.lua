...
AVA:evaluate()
AVA:cuda()
AVA_score_list1 = torch.Tensor(200, 1):zero()
AVA_score_list2 = torch.Tensor(200, 1):zero()
...
for g = 1,26,25 do
  ...
  netG:evaluate()
  netG:cuda()
  os.execute("mkdir " .. string.format('FINAL_old_100_results/result_%s', netG_iter))
  new_results = string.format('FINAL_old_100_results/result_%s', netG_iter)
  for i = 1, 200 do
